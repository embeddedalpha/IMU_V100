...
volatile uint8_t acceleration[6], gyro[6] ;
...
//	I2C_Master_Write_Register(MPU9250, MPU9250_ADDRESS, ACCEL_CONFIG2, 0x06);
	...
	I2C_Master_Write_Register(&mpu6050, mpu6050_address, 0x1A, 0x03); //4G
	I2C_Master_Write_Register(&mpu6050, mpu6050_address, 0x19, 7); //500 DPS
	I2C_Master_Write_Register(&mpu6050, mpu6050_address, 0x1B, 0x00);
	I2C_Master_Write_Register(&mpu6050, mpu6050_address, 0x1C, 0x00);
	I2C_Master_Write_Register(&mpu6050, mpu6050_address, INT_PIN_CFG, 0x00);
